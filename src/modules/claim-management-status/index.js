...
const repository = createCrudRepository({
  modelName: 'claimManagementStatus',
...
const {
  ...
  repository,
  entityName: 'claim-management-status',
  topicPrefix: 'csx.claim-management-status',
  outboxService
});
...
module.exports = {
  claimManagementStatusController: controller,
  claimManagementStatusRepository: repository
};
