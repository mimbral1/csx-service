...
const {
  ...
  repository,
  entityName: 'claim-management',
  topicPrefix: 'csx.claim-management',
  outboxService
});
...
module.exports = {
  claimManagementController: controller,
  claimManagementRepository: repository
};
